...
public class SharedKingAttributes extends SharedMonsterAttributes
{
	...
	public static final IAttribute ARMOR = (new RangedAttribute((IAttribute)null, "kingofglory.armor", 0D, 0D, 2048.0D)).setDescription("Armor in King").setShouldWatch(true);
	public static final IAttribute MAGIC_DEFENCE = (new RangedAttribute((IAttribute)null, "kingofglory.magicDefence", 0D, 0D, 2048.0D)).setDescription("Magic Defence").setShouldWatch(true);
	...
	public static final IAttribute COOLDOWN_REDUCTION = (new RangedAttribute((IAttribute)null, "kingofglory.cooldownReduction", 0D, 0D, 0.4D)).setDescription("Cooldown Reduction").setShouldWatch(true);
	...
	public static final IAttribute MANA_PER_5_SECOND = (new RangedAttribute((IAttribute)null, "kingofglory.manaPer5Second", 0D, 0D, 1024D)).setDescription("Mana/5 seconde").setShouldWatch(true);
	public static final IAttribute HP_PER_5_SECOND = (new RangedAttribute((IAttribute)null, "kingofglory.HPPer5Second", 0D, 0D, 1024D)).setDescription("HP/5 seconde").setShouldWatch(true);
