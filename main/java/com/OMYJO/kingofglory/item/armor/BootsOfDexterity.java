...
public class BootsOfDexterity extends KingOfArmor implements KingOfItem
{
	...
	private final UUID ATTACK_SPEED_MODIFIER = UUID.randomUUID();

	public BootsOfDexterity()
	{
		super(new KingOfArmorMaterial().setName("boots_of_dexterity"), EquipmentSlotType.FEET, Rarity.UNCOMMON);
	...
	public Multimap<String, AttributeModifier> getAttributeModifiers(EquipmentSlotType equipmentSlot)
	{
		...
		if(equipmentSlot == getEquipmentSlot())
		{
			...
			multimap.put(SharedMonsterAttributes.ATTACK_SPEED.getName(),new AttributeModifier(ATTACK_SPEED_MODIFIER,"Armor modifier", getAttackSpeed(), AttributeModifier.Operation.MULTIPLY_BASE));
		}
		return multimap;
	}
}
