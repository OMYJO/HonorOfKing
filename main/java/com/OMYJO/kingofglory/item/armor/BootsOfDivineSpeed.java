...
public class BootsOfDivineSpeed extends KingOfArmor implements KingOfItem
{
	private float movementSpeed = Helper.movementSpeed(30);
	public static final UUID MOVEMENT_SPEED_MODIFIER = UUID.randomUUID();

	public BootsOfDivineSpeed()
	{
		super(new KingOfArmorMaterial().setName("boots_of_divine_speed"), EquipmentSlotType.FEET, Rarity.COMMON);
